...
# from mydataset import TestDataset, MaskBaseDataset
...
#     parser.add_argument('--model_dir', tydpe=str, default=os.environ.get('SM_CHANNEL_MODEL', './model/exp7'))
...
if __name__ == '__main__':
    ...
    # Container environment
    parser.add_argument('--data_dir', type=str, default=os.environ.get('SM_CHANNEL_EVAL', '/opt/ml/input/data/eval'))
    parser.add_argument('--model_dir', type=str, default=os.environ.get('SM_CHANNEL_MODEL', './model/exp7'))
    parser.add_argument('--output_dir', type=str, default=os.environ.get('SM_OUTPUT_DATA_DIR', './output'))
