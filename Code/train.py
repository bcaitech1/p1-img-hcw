...
from mydataset import MaskBaseDataset
# import dataset
...
def train(data_dir, model_dir, args):
    ...
    # -- dataset
    dataset_module = getattr(import_module("mydataset"), args.dataset)  # default: BaseAugmentation
    ...
    # -- augmentation
    transform_module = getattr(import_module("mydataset"), args.augmentation)  # default: BaseAugmentation
    ...
    opt_module = getattr(import_module("adamp"), args.optimizer)  # default: SGD
